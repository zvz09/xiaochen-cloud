package com.zvz09.xiaochen.data.desensitize.serializer;
...
public class DesensitizeJsonSerializer extends JsonSerializer<Object> implements ContextualSerializer {
    ...
    public void serialize(Object value, JsonGenerator gen, SerializerProvider serializers) throws IOException {
        ...
        if (desensitize.toEmpty()) {
            ...
            // 脱敏
            String mix = Desensitizes.mix(Desensitizes.object2String(value), desensitize.keepStart(), desensitize.keepEnd(), desensitize.replacer());
            gen.writeString(mix);
        }
    }
